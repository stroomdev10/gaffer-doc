...
- uk.gov.gchq.gaffer.operation.io.MultiInput - Use this in addition if your
...
The respective operation handler for each store should also have an associated unit test class.
